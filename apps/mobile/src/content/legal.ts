// In-app legal copy (Privacy Policy + Terms of Service), rendered natively by
// app/(shared)/legal.tsx. Kept in sync with the server-rendered pages in
// apps/api/src/legal.ts. We render this natively (not a webview) so the
// documents work offline and match the app's typography.

export const SUPPORT_EMAIL = 'support@ednacharge.com';
...
export const PRIVACY: LegalDoc = {
  ...
  blocks: [
    ...
    },
    {
      ...
      body: `You can review and update profile information in the app, disable location access in your device settings, and request access to or deletion of your account and personal data by emailing ${SUPPORT_EMAIL}. We will respond consistent with applicable law.`,
    },
    {
      heading: 'Security',
...
export const TERMS: LegalDoc = {
  ...
  blocks: [
    ...
    },
    {
      ...
      body: `These Terms are governed by the laws of the State of ${GOVERNING_STATE}, United States, without regard to conflict-of-laws rules.`,
    },
    {
      heading: 'Contact',
